    ...
    <>
      <section className="w-full h-screen animate-fade-in select-none flex overflow-hidden">
        ...
        <div className="w-full h-full space-y-8 p-2 md:p-4 lg:p-8 overflow-y-scroll lg:overflow-hidden">
          <Total />
          <div
            className={`animate-fade-in w-full h-fit lg:max-h-[68vh] p-2 md:p-4 rounded-lg border border-zinc-300 dark:border-zinc-800/50 border-opacity-30 shadow-sm dark:shadow-muted hover:shadow-md ease-in-out duration-300 overflow-hidden`}
          >
            {children}
          </div>
        </div>
